 ...
 * @author lenovo
 */
public class S_login extends Application {
    Label l1,l2,l3;
    TextField t1,t2;
    @Override
    public void start(Stage primaryStage) {
        ...
        b.setOnAction(e->{
          ...
          try {
            Conn ob=new Conn();
           ResultSet rs= ob.s.executeQuery("select email,password from student where email="+s1+"and password="+s2+";");
         if(rs.next()==true)
         {  T_window op=new T_window();
            Stage sk=new Stage();

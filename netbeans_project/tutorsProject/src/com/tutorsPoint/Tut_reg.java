 ...
 * @author lenovo
 */
public class Tut_reg extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        VBox v=new VBox(tutor,h1,h2,h3,h4,h5,h6);
        v.setSpacing(30);
        ...
        b1.setOnAction(e->{
          ...
          try { Conn c=new Conn();
           String ss="insert into tutor(name,email,phone,subject,location,password) values("+s1+","+s2+","+s3+","+s4+","+s5+","+s6+");";
        ...
        primaryStage.setTitle("Tutor-Registration");
